...
namespace Business.Concrete
{
    public class CityManager : ICityService
    {
        ...
        {
            return new SuccessDataResult<City>(_cityDal.Get(c => c.CityId == cityId) ,CityMessages.CityListed);
        }

        public IDataResult<List<City>> GetAll()
        {
            return new SuccessDataResult<List<City>>(_cityDal.GetAll(), CityMessages.CityListed);
        }
